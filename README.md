...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "http-almaren" % "0.1.2-2.4"
```

```
spark-shell --master "local[*]" --packages "com.github.music-of-the-ainur:almaren-framework_2.11:0.5.0-2.4,com.github.music-of-the-ainur:http-almaren_2.11:0.1.2-2.4"
```
